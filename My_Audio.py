...
my_speak1("Hello Arsh Mishra this is sentraa your personal voice assistant")
print("____________________________________________Hello Arsh This Is sentraa Here!____________________________________________")
print()
while True:
